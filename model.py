...
#%%
input_data = Input(shape= (21, 64, 64, 1))  #frame, height, width, channels

convolution1 = TimeDistributed(Conv2D(filters=64, kernel_size=(1,1), activation='relu'))(input_data)
convolution1 = TimeDistributed(Conv2D(filters=64, kernel_size=(1,1), activation='relu'))(convolution1)
...
pooling2 = TimeDistributed(MaxPooling2D(pool_size=(2,2)))(convolution2)
...
pooling3 = TimeDistributed(MaxPooling2D(pool_size=(2,2)))(convolution3)

flatten = TimeDistributed(Flatten())(pooling3)

blstm = Bidirectional(LSTM(128, return_sequences=True, dropout=0.1))(flatten)
